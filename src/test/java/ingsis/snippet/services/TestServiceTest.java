...
public class TestServiceTest {
  ...
  void testRun() {
    ...
    when(printScriptServiceHandler.executeTest(
            snippetId, "1.1", List.of(), List.of("Hello, World!"), token))
        .thenReturn(Response.withData(null));
    ...
    when(printScriptServiceHandler.executeTest(
            snippetId, "1.1", List.of(), List.of("Hello, World2"), token))
  ...
  void testDecodeToken() {
    String userId =
        "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IkMzTWR4a0tXVXpsaGhtVjRYZGJsTiJ9..oSydpNeTuMmyeOaBHWYA4WITrWLjGTlmoPrGzDvyQLlVJg08wc_9Kr4CFu5QJGsVXZ7b2rac2lj-w16HQIsZk8oY4Fx4dFb70cioivTKuDc2M7uQVukV_1yWhgJRgcH5AnUuglP0TD77Mt-oL98Ah_GR9ZOrf3OzyHnZ5Rv6kcSfOr6MsgyPAQSivtmQSSvWLC-_B6eDXtvPP9jeycXYr7Czt8OPrSI22T4nABZiTiwMuLNXFxd3RpLZl4-SGCyj7uLMoMXATXSL54cY-G5XzbqSfgO7O8niAHHveQbNClbXaoUGrOuaUi9Sfzpa8DcQiLUDlC7FNRipOk5V7SnCAA";
