...
public class TestController {
  ...
  public ResponseEntity<Object> createTest(
      @RequestBody TestDTO testDTO, @RequestHeader("Authorization") String token) {
  ...
  @GetMapping("/get-all")
  public ResponseEntity<Object> getTestsForSnippet(
  ...
  public ResponseEntity<Object> deleteTest(
      @RequestParam String testId, @RequestHeader("Authorization") String token) {
