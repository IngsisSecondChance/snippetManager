...
public class SnippetService {
  ...
  public Response<PaginationAndDetails> getAccessibleSnippets(
    ...
    Response<List<SnippetPermissionGrantResponse>> relationshipsResponse =
    ...
    List<Snippet> snippets =
        snippetRepository.findByIdInAndTitleStartingWith(
            relationships.stream().map(SnippetPermissionGrantResponse::getSnippetId).toList(),
            name,
            pageable);
    System.out.println(snippets);
    List<SnippetCodeDetails> snippetDetails =
        snippets.stream()
            .map(
                snippet -> {
                  ...
                  String author =
                      relationships.stream()
                          ...
                          .map(SnippetPermissionGrantResponse::getAuthor)
                          .findFirst()
                          .orElse(null);
    ...
    PaginationAndDetails paginationAndDetails =
        new PaginationAndDetails(page, pageSize, relationships.size(), snippetDetails);
